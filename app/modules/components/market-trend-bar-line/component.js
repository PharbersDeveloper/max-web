...
export default Component.extend({
    ...
    drawChart() {
        ...
        let xDatas = dataset.map(elem => elem.date);
        let values = dataset.map(elem => elem.marketSales*(4/3));
        let values2 = dataset.map(elem => elem.percentage*(4/3));
        ...
        chart.append('rect')
            ...
            .attr('height', function (d) { return height - yScale(d.marketSales); })
            .attr('y', function (d) { return yScale(d.marketSales); })
        ...
        let line = d3.line()
            ...
            .y(function (d) { return yScale2(d.percentage); });
